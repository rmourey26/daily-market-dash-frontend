...
import SemiFinalGuest from "../../Guest/SemiFinalGuest/index.jsx";
...
const SemiFinalUser = ({
   ...
   const [openHoldingAllLeader, setopenHoldingAllLeader] = useState(false);
   ...
   return (
      <>
         {bracketsdatamygame && bracketsdatamygame.isPlayer == 1 ? (
            <div className="container-fluid SemiFinalUser">
