...
import styles from "./MarketDataInternalstyles/MostWatched.module.scss";

const MarketDataWatched = ({ stock, action, openModal }) => {
  return (
    <>
      {stock.watchlist && stock && action && action === "watched" && (
        <div className={styles["market-sec-last"]}>
          {stock?.watchlist.map((stock) => (
              ...
              <div
                className={
                  stock.market_mic == "XCRY"
                    ? styles["col-4"] + " " + styles["watchedcrypto"]
                    : styles["col-4"]
                }
              >
...
export default MarketDataWatched;
